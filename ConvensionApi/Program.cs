...
{
    options.AddPolicy("ReadAccess", policy => policy.RequireClaim("permissions", "participant"));
    options.AddPolicy("WriteAccess", policy => policy.RequireClaim("permissions", "administrator"));
